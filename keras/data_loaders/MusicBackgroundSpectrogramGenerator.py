...
class MusicBackgroundSpectrogramGenerator(object):
	...
	def get_generator(self):
		...
		while True:
			...
			try:
				...
				print("MusicBackgroundSpectrogramGenerator Exception: ", e, file)
				pass
...
if __name__ == "__main__":
	...
	a = MusicBackgroundSpectrogramGenerator("/Users/therold/Uni/master-thesis/datasets/EUSpeech/english/input.wav", {"pixel_per_second": 50, "input_shape": [129, 100, 1], "batch_size": 32, "num_classes": 4}, shuffle=True)
	gen = a.get_generator()
