...
class DirectoryLoader(object):
	...
	def __init__(self, source_directory, config, shuffle=True):
		...
		self.generators = [SpectrogramGenerator(os.path.join(self.source_directory, "english"), config, shuffle=shuffle),SpectrogramGenerator(os.path.join(self.source_directory, "german"), config, shuffle=shuffle),SpectrogramGenerator(os.path.join(self.source_directory, "french"), config, shuffle=shuffle),SpectrogramGenerator(os.path.join(self.source_directory, "spanish"), config, shuffle=shuffle),]
